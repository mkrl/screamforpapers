...
<div class="h-screen grid grid-cols-12 gap-6 p-6">
    <aside class="col-span-4 border-2 border-dashed rounded-xl p-6 overflow-y-auto flex flex-col justify-between" style="height: calc(100vh - 3rem)">
        ...
        <footer class="flex items-center mt-9">
            <Img src={Logo} imgClass="w-6 h-6 mr-4 opacity-40"/> <h5 class="text-gray-300 text-lg">Scream For Papers v. {packageJson.version}</h5>
        </footer>
    </aside>
